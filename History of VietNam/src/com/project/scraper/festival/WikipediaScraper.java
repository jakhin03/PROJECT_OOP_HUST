package com.project.scraper.festival;
...
public class WikipediaScraper extends AScraper implements IScraper, IDataToScrape {
        ...
        for (Element fes : festivals) {
            ...
            if (diaDiem.equals("An Giang") || diaDiem.equals("Bắc Ninh") || diaDiem.equals("Tuyên Quang")
                ...
                for (String name : names) {
                    ...
                    festival.setCharacter(new com.project.historydatabase.figure.Character(""));
                    festival.setNoiDung("");
                    list.add(festival);
                } // end for 2
            }
    ...
    public static void main(String[] args) {
        WikipediaScraper obj = new WikipediaScraper();
        obj.scrape();
        String filePath = "D:\\HistoryVietnam\\FestivalJSon\\festival.json";
